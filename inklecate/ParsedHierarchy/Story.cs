...
namespace Ink.Parsed
{
	internal class Story : FlowBase
    {
        ...
        public Runtime.Story ExportRuntime(ErrorHandler errorHandler = null)
		{
            ...
            // Set definitions are treated like constants too - they should be usable
            // from other variable declarations.
            _setDefs = new Dictionary<string, SetDefinition> ();
            foreach (var setDef in FindAll<SetDefinition> ()) {
                _setDefs [setDef.name] = setDef;
            }
            ...
            var runtimeSets = new List<Runtime.Set> ();
            foreach (var nameDeclPair in variableDeclarations) {
                ...
                if (varDecl.isGlobalDeclaration) {
                    ...
                    if (varDecl.setDefinition != null) {
                        ...
                        runtimeSets.Add (varDecl.setDefinition.runtimeSetDefinition);
                    } else {
            ...
            var runtimeStory = new Runtime.Story (rootContainer, runtimeSets);
