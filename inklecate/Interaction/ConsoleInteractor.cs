...
namespace Ink.Inklecate.Interaction
{
    public class ConsoleInteractor : IConsoleInteractable
    {
        ...
        public void WriteInformation(string name, object value, object secondValue)
        {
            Console.WriteLine(name, value, secondValue);
        }
        ...
        public void WriteJsonInformation(string json)
        {
            Console.WriteLine(json);
        }

        public void WriteJsonWarning(string json)
        {
            Console.WriteLine(json);
        }

        public void WriteJsonError(string json)
        {
            Console.WriteLine(json);
        }

        public void WriteJsonNameValuePair(string name, object value)
        {
