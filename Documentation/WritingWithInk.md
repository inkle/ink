...
- [Part One: The Basics](#part-one-the-basics)
    ...
    - [Diverts](#4-diverts)
        - [Knots divert to knots](#knots-divert-to-knots)
            ...
            - [Glue](#glue)
    - [Branching The Flow](#5-branching-the-flow)
    ...
    - [Includes and Stitches](#6-includes-and-stitches)
    ...
    - [Varying Choices](#7-varying-choices)
        ...
        - [Conditional Choices](#conditional-choices)
            ...
            - [Logical operators: AND and OR](#logical-operators-and-and-or)
    ...
    - [Game Queries and Functions](#9-game-queries-and-functions)
        - [CHOICE_COUNT](#choice_count)
        - [TURNS](#turns)
        - [TURNS_SINCE-> knot](#turns_since--knot)
            - [Sneak preview: using TURNS_SINCE in a function](#sneak-preview-using-turns_since-in-a-function)
...
- [Part 2: Weave](#part-2-weave)
    ...
    - [Tracking a Weave](#3-tracking-a-weave)
...
- [Part 3: Variables and Logic](#part-3-variables-and-logic)
    ...
    - [Temporary Variables](#4-temporary-variables)
    ...
    - [Advanced: Game-side logic](#7-advanced-game-side-logic)
...
- [Part 5: Advanced State Tracking](#part-5-advanced-state-tracking)
    ...
    - [Basic Lists](#1-basic-lists)
    - [Reusing Lists](#2-reusing-lists)
    ...
    - [Multivalued Lists](#4-multivalued-lists)
    ...
    - [Advanced List Operations](#5-advanced-list-operations)
    ...
    - [Multi-list Lists](#6-multi-list-lists)
    ...
    - [Long example: crime scene](#7-long-example-crime-scene)
    - [Summary](#8-summary)
        - [Flags](#flags)
