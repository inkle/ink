...
- [Part One: The Basics](#part-one-the-basics)
    ...
    - [Diverts](#diverts)
        - [Knots divert to knots](#knots-divert-to-knots)
            ...
            - [Glue](#glue)
    - [Branching The Flow](#branching-the-flow)
    ...
    - [Includes and Stitches](#includes-and-stitches)
    ...
    - [Game Queries and Functions](#game-queries-and-functions)
...
- [Part 2: Weave](#part-2-weave)
    ...
    - [Tracking a Weave](#tracking-a-weave)
...
- [Part 3: Variables and Logic](#part-3-variables-and-logic)
    ...
    - [Advanced: Game-side logic](#advanced-game-side-logic)
...
- [Part 5: Advanced State Tracking](#part-5-advanced-state-tracking)
    ...
    - [Multivalued Lists](#multivalued-lists)
    ...
    - [Multi-list Lists](#multi-list-lists)
    ...
    - [Long example: crime scene](#long-example-crime-scene)
    - [Summary](#summary)
        - [Flags](#flags)
