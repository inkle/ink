...
- [Part One: The Basics](#part-one-the-basics)
	...
	- [8) Varying Choices](#8-varying-choices)
	...
	- [9) Variable Text](#9-variable-text)
		- [Text can vary](#text-can-vary)
		- [Sequences, cycles and other lists](#sequences-cycles-and-other-lists)
			- [List types](#list-types)
			- [Features of Lists](#features-of-lists)
			- [Examples](#examples)
			- [Advanced: Multiline lists](#advanced-multiline-lists)
		- [Conditional Text](#conditional-text)
	- [10) Game Queries](#10-game-queries)
...
- [Part 3: Variables and Logic](#part-3-variables-and-logic)
	...
	- [3) Conditional blocks (if/else)](#3-conditional-blocks-ifelse)
		...
		- [Multiline list blocks](#multiline-list-blocks)
...
- [Part 5: Advanced State Tracking](#part-5-advanced-state-tracking)
	...
	- [6) Long example: crime scene](#6-long-example-crime-scene)
	- [7) Summary](#7-summary)
		- [Flags](#flags)
